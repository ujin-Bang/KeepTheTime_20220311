...
class MyFriendsFragment: BaseFragment() {
    ...
    lateinit var mFriendAdapter : MyFriendRecyclerAdapterr
    ...
    override fun setValues() {
        ...
        mFriendAdapter = MyFriendRecyclerAdapterr(mContext, mMyFriendsList)
    ...
    fun getMyFriendsFromserver(){
        ...
        apiList.getRequestFriendLis("my").enqueue(object : Callback<BasicResponse>{
